...
const server = https
	.createServer(
		{
			key: fs.readFileSync('/etc/letsencrypt/live/theparadigm.ga/privkey.pem'),
			cert: fs.readFileSync('/etc/letsencrypt/live/theparadigm.ga/fullchain.pem')
		},
		app
	)
	.listen(port, host);
...
const io = socket(server, {
	...
	cors: {
		origin: [
			...
			'app://.',
			'https://www.theparadigm.ga',
			'https://theparadigm.ga',
			'http://www.theparadigm.ga',
			'http://theparadigm.ga'
		],
		methods: ['GET', 'POST']
	}
